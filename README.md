...
Example package tutorial from CCV Bootcamp 2026

`example-package-lhoogstr` is a simple Python library that contains a single function for rescaling arrays.
